...
# tax rates
tax_rate = Shoppe::TaxRate.create!(:name => "maximo", :rate => 20.0)
exempt_tax = Shoppe::TaxRate.create!(:name => "Sin Descuento", :rate => 0.0)
tax_rate1 = Shoppe::TaxRate.create!(:name => "minimo", :rate => 10.0)
tax_rate2 = Shoppe::TaxRate.create!(:name => "estandar", :rate => 15.0)
...
client1 = Shoppe::Client.create({:nit => '123456', :first_name => 'Pablo', :last_name => 'Neruda', :email_address => 'pabloneruda@hotmail.com', :company => 'Motosss', :billing_address1 => 'cr 96 # 49 AB 16', :billing_postcode => '57',:phone_number => '5869888'})
client1 = Shoppe::Client.create({:nit => '678901', :first_name => 'juan', :last_name => 'mora', :email_address => 'ablo@hotmail.com', :company => 'tor', :billing_address1 => 'cr 89 # 49 A 6', :billing_postcode => '57',:phone_number => '2345888'})
client1 = Shoppe::Client.create({:nit => '987654', :first_name => 'daniel', :last_name => 'lila', :email_address => 'oneru@hotmail.com', :company => 'Mosor', :billing_address1 => 'cr 46 # 6 B 96', :billing_postcode => '57',:phone_number => '58694567'})
# categories
