...
class CreateShoppeInitialSchema < ActiveRecord::Migration
  def up
    ...
    create_table "shoppe_delivery_services" do |t|
      ...
      create_table "shoppe_client" do |t|
      t.string   "nit"
      t.string   "first_name"
      t.string   "last_name"
      t.string   "company"
  ...
  def down
    [:users, :tax_rates, :stock_level_adjustments, :settings, :products, :product_categories, :product_attributes, :orders, :order_items, :delivery_services, :delivery_service_prices, :countries, :client].each do |table|
